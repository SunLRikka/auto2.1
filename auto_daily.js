...
const { click, performGlobalAction, swipe } = require("accessibility");
...
const { wakeUp } = require("power_manager");
...
async function main() {
    ...
    await click(561, 2032);
    await click(826, 1669);
    await click(237, 1520);
    await click(561, 1501);
    // 兽耳助手签到
    await kemomimi();
    // 米游社签到
    await hyperion();
